...
class HRMApp:
    def __init__(self, root, emp_id):
        ...
        self.menu_buttons = {}
        self.menu_icons = {}  # Dictionary để lưu trữ icon
        self.employee = None 
        self.conn = None 
        self.cursor = None
    ...
    def menu(self):
        ...
        img_path = os.path.join(BASE_DIR, "..", "img", "face", "VoThiThuLuyen.jpg")
    ...
    def main_content(self):
        ...
        # Avt
        BASE_DIR = os.path.dirname(os.path.abspath(__file__))
        avt = os.path.join(BASE_DIR, "..", "img", "face", "VoThiThuLuyen.jpg")
